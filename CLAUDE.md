...
- **Latest versions.** Pick the newest stable release of every library when adding or bumping (check `npm view <pkg> version`). Exception: `@types/node` tracks the installed Node major, not the newest.
